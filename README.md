...
# Изменения по ревью
Парсинг ответа json и отправка http запроса вынесены в интерфейсы \
json/json.h \
net/net.h \

реализация интерфейсов подключена в билд-скрипте build.sh

Улучшен парсинг ответа формата json
